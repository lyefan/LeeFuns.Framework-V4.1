using LeeFuns.DataAccess.DbExpand;
using System;
...
namespace LeeFuns.DataAccess
{
    public class Database : IDatabase, IDisposable
    {
        ...
        public List<T> FindListPage<T>(string WhereSql, DbParameter[] parameters, string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount) where T: new()
        {
            StringBuilder builder = DatabaseCommon.SelectSql<T>();
            builder.Append(WhereSql);
            return SqlServerHelper.GetPageList<T>(builder.ToString(), parameters, orderField, orderType, pageIndex, pageSize, ref recordCount);
        }
        ...
        public DataTable FindTablePage<T>(string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount) where T: new()
        {
            ...
            switch (DbHelper.DbType)
            {
                case DatabaseType.Oracle:
                    dataTable1 = OracleHelper.GetPageTable(DatabaseCommon.SelectSql<T>().ToString(), orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.SqlServer:
                    dataTable1 = SqlServerHelper.GetPageTable(DatabaseCommon.SelectSql<T>().ToString(), orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
        ...
        public DataTable FindTablePage<T>(string WhereSql, string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount) where T: new()
        {
            ...
            {
                case DatabaseType.Oracle:
                    dataTable1 = OracleHelper.GetPageTable(builder.ToString(), orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.SqlServer:
                    dataTable1 = SqlServerHelper.GetPageTable(builder.ToString(), orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.Access:
                    break;
                case DatabaseType.MySql:
        ...
        public DataTable FindTablePage<T>(string WhereSql, DbParameter[] parameters, string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount) where T: new()
        {
            ...
            {
                case DatabaseType.Oracle:
                    dataTable1 = OracleHelper.GetPageTable(builder.ToString(), parameters, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.SqlServer:
                    dataTable1 = SqlServerHelper.GetPageTable(builder.ToString(), parameters, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.Access:
                    break;
                case DatabaseType.MySql:
        ...
        public DataTable FindTablePageBySql(string strSql, string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount)
        {
            ...
            {
                case DatabaseType.Oracle: 
                    dataTable1 = OracleHelper.GetPageTable(strSql, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.SqlServer:
                    dataTable1 = SqlServerHelper.GetPageTable(strSql, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.Access:
                    break;
                case DatabaseType.MySql:
        ...
        public DataTable FindTablePageBySql(string strSql, DbParameter[] parameters, string orderField, string orderType, int pageIndex, int pageSize, ref int recordCount)
        {
            ...
            {
                case DatabaseType.Oracle:
                    dataTable1 = OracleHelper.GetPageTable(strSql, parameters, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.SqlServer:
                    dataTable1 = SqlServerHelper.GetPageTable(strSql, parameters, orderField, orderType, pageIndex, pageSize, ref recordCount);
                    break;
                case DatabaseType.Access:
                    break;
                case DatabaseType.MySql:
